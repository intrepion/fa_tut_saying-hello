...
(cd workspace && npm pkg set scripts.dev="astro dev --host 0.0.0.0 --port 25616")
git add --all
git commit --message "(cd workspace && npm pkg set scripts.dev=\"astro dev --host 0.0.0.0 --port 25616\")"

(cd workspace && npm pkg set scripts.build="astro build")
git add --all
git commit --message "(cd workspace && npm pkg set scripts.build=\"astro build\")"

(cd workspace && npm pkg set scripts.preview="astro preview --host 0.0.0.0 --port 25616")
git add --all
git commit --message "(cd workspace && npm pkg set scripts.preview=\"astro preview --host 0.0.0.0 --port 25616\")"

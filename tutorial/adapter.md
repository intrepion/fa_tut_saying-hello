...
```bash
dotnet new console --language C# --output src/SayingHello.CommandLine --name SayingHello.CommandLine
dotnet new xunit --language C# --output tests/SayingHello.CommandLine.Tests --name SayingHello.CommandLine.Tests
dotnet sln SayingHello.sln add src/SayingHello.CommandLine/SayingHello.CommandLine.csproj
dotnet sln SayingHello.sln add tests/SayingHello.CommandLine.Tests/SayingHello.CommandLine.Tests.csproj
dotnet add src/SayingHello.CommandLine/SayingHello.CommandLine.csproj reference src/SayingHello.Contracts/SayingHello.Contracts.csproj
dotnet add tests/SayingHello.CommandLine.Tests/SayingHello.CommandLine.Tests.csproj reference src/SayingHello.Contracts/SayingHello.Contracts.csproj
dotnet add src/SayingHello.CommandLine/SayingHello.CommandLine.csproj reference src/SayingHello/SayingHello.csproj
dotnet add tests/SayingHello.CommandLine.Tests/SayingHello.CommandLine.Tests.csproj reference src/SayingHello.CommandLine/SayingHello.CommandLine.csproj
```

...
just format
git add --all
git commit --message 'touch workspace/internal/adapter/http/greeting_handler_test.go'
```
...
just format
git add --all
git commit --message 'touch workspace/internal/adapter/http/greeting_handler.go'
```

...
just check-tests
git add -A
git commit -m "1. Red: Add The First Failing Test"
```
...
just check-tests
git add -A
git commit -m "2. Green: Add The Smallest Production Code"
```
...
just check-tests
git add -A
git commit -m "3. Red: Add The Trimming Test"
```
...
just check-tests
git add -A
git commit -m "4. Green: Make The Trimming Test Pass"
```
...
just check-tests
git add -A
git commit -m "5. Red: Add The Empty-String Test"
```
...
just check-tests
git add -A
git commit -m "6. Green: Make The Empty-String Test Pass"
```
...
just check-tests
git add -A
git commit -m "7. Red: Add The Whitespace-Only Test"
```
...
just check-tests
git add -A
git commit -m "8. Green: Finish The Core Behavior"
```
